...
<p>
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
          echo 'More info: <a href="https://www.socialengine.com/support/article/5145078/se-php-menu-editor" target="_blank">See KB article</a>.';	

    if( Zend_Controller_Front::getInstance()->getRequest()->getParam('name') == "core_social_sites" ) {
      echo '<br> For more info on how to change the social footer menu icons, read this <a href="https://www.socialengine.com/support/article/5308967/se-php-social-footer-menu-icons" target="_blank">KB article</a>';
    }
  } 
  ?>	
</p>
