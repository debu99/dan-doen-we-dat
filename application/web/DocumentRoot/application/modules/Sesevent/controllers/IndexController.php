...
class Sesevent_IndexController extends Core_Controller_Action_Standard {
  ...
  public function followAction() {
	...
	public function uploadCoverAction(){
		...
		echo json_encode(array('file'=>Engine_Api::_()->storage()->get($event->cover_photo)->getPhotoUrl('')));die;
	}
	...
	public function removeCoverAction(){
		...
		echo json_encode(array('file'=>$event->getCoverPhotoUrl()));die;
	}
	...
	public function uploadMainAction(){
		...
		echo json_encode(array('file'=>$event->getPhotoUrl()));die;
	}
