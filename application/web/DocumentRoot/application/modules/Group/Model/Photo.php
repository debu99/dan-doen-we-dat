...
class Group_Model_Photo extends Core_Model_Item_Collectible
{
    ...
    {
      return Engine_Api::_()->authorization()->isAllowed('group', $user, 'photo_edit'); //$this->getParent()->getParent()->authorization()->isAllowed($user, 'photo_edit');
    }

    public function canDelete($user)
    {
        return Engine_Api::_()->authorization()->isAllowed('group', $user, 'photo_delete'); //$this->getParent()->getParent()->authorization()->isAllowed($user, 'photo_delete'); 
    }
}
